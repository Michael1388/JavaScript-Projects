...
const Calculator = {
    ...
    First_Operand: null,
    // this checks whether ot not the second Operand has been inputted by the user.
...
function Input_Decimal(dot) {
    ...
    //doesn't cause bugs in the opertion.
    if (Calculator.Wait_Second_Operand === true) return;
    if(!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_Value does not contain a decilmal point
...
function Handle_Operator(Next_Operator) {
    ...
    //then updates the operator and exits from the funciton.
...
//This function update the calculator screen with the contents of Diplay_Value
