...
function animal_Dictionary() { /*define a function called "animal_Dictionary" to create a dictionary*/
    var Animal = {              /* define the object "Animal" and the following KVP variables*/
        ...
        Sound:"Rouf!"    /* Assign IDENTICAL KEY to OBSERVE the result */
    };
    delete Animal.Sound; /* deletes the Key "Sound" and because it now no longer exists will return "undefined" whne called by our HTML code request for this result*/
